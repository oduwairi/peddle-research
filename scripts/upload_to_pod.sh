...
INCLUDE_PATHS=(
    ...
    "scripts/inference_tui.py"
    "scripts/train_v2_bakeoff.sh"
    "scripts/construct_v2/render_for_gemma.py"
    "scripts/eval.py"
    "configs/training_v2.yaml"
    "configs/training_v2_qwen.yaml"
    "configs/training_v2_gemma_native.yaml"
    "configs/eval.yaml"
    "data/constructed_v2/final_v2"
    "pyproject.toml"
    "Makefile"
    "README.md"
)
